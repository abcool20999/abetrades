...
import './Heading.css';
import forexUrl from '../../../assets/forex.jpeg'


const Heading = () => {
    return (
      <div id='homepage_heading' className='pb-5 bg-image pt-5 align-items-center' style={{backgroundImage: `url(${forexUrl})`, backgroundSize: 'cover', height: "500px"}}>
